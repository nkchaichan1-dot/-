...
// Note: In serverless environment, memory cache is shared across warm starts.
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    console.log("[Vercel API] Cache expired or empty. Fetching fresh data from Google Sheets...");
    ...
    console.error("[Vercel API Error] Error in api/projects handler:", error);
